const products = [
  ...
  {
    _id: "qkrx15548",
    name: "КРОССОВКИ БАСКЕТБОЛЬНЫЕ SE900 NBA LOS ANGELES LAKERS",
    brand: "TARMAK",
    type: "Кроссовки",
    amount: 71,
    price: 6999,
  ...
  {
    _id: "gdu9fyri7",
    name: "КРОССОВКИ ДЛЯ БЕГА МУЖСКИЕ GEL-PULSE 13 GTX",
    brand: "ASICS",
    type: "Кроссовки",
    amount: 71,
    price: 9999,
  ...
  {
    _id: "cspo0n00f",
    name: "ВЕЛОТРЕНАЖЕР ЭЛЛИПТИЧЕСКИЙ С АВТОНОМНЫМ ПИТАНИЕМ EL 520",
    brand: "ASICS",
    type: "Снаряжение",
    amount: 7,
    price: 35999,
  ...
  {
    _id: "clsdxhoji",
    name: "НАБОР ИЗ ГАНТЕЛЕЙ И ШТАНГИ ДЛЯ СИЛОВЫХ ТРЕНИРОВОК",
    brand: "IMVISO",
    type: "Снаряжение",
    amount: 7,
    price: 16999,
